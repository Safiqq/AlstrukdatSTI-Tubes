...
/* ElTypeList adalah ADT yg menyimpan koordinat x dan y, serta info pada koordinat tsb. */

#ifndef __LISTLINIER_H__
#define __LISTLINIER_H__
...
void DelPList(List *L, char X, int x, int y);
/* I.S. Sembarang */
